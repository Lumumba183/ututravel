...
export default function Conservation() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[100dvh] bg-[#F6F5F2] overflow-hidden z-100">
      {/* Full-bleed Image */}
      <div
        ref={imageRef}
      ...
      >
        <img
          src="/images/wilddog_closeup.jpg"
          alt="African Wild Dog"
          className="w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0B0C0E]/50 to-transparent" />
      </div>
      ...
      >
        <div className="px-6 md:px-[6vw] pb-[9vh] md:pb-0 w-full max-w-full md:max-w-[38vw]">
          <div ref={headlineRef}>
            ...
            >
              <span className="headline-word inline-block">Conservation</span>
            </h2>
          </div>

          <p className="text-[#6E6F73] text-base leading-relaxed mb-8 max-w-md">
            We partner with local rangers, communities, and eco-camps to keep these landscapes thriving.
          </p>
