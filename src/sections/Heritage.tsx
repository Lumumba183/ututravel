...
export default function Heritage() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[100dvh] bg-[#F6F5F2] overflow-hidden z-50">
      {/* Full-bleed Image */}
      <div
        ref={imageRef}
      ...
      >
        <img
          src="/images/gorilla_portrait.jpg"
      ...
      >
        <div className="px-6 md:px-[6vw] pb-[9vh] md:pb-0 w-full max-w-full md:max-w-[38vw]">
          <div ref={headlineRef}>
            ...
            >
              <span className="headline-word inline-block">Heritage</span>
            </h2>
          </div>

          <p className="text-[#6E6F73] text-base leading-relaxed mb-8 max-w-md">
            Gorilla trekking, village visits, and conservation storytelling—connected to the people protecting these lands.
          </p>
