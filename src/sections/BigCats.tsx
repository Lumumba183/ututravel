...
export default function BigCats() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-[100dvh] bg-[#F6F5F2] overflow-hidden z-40">
      ...
      >
        <div className="px-6 md:px-[6vw] w-full max-w-full md:max-w-[38vw]">
          <div ref={headlineRef}>
            ...
            >
              <span className="headline-word inline-block">Big</span>{' '}
              <span className="headline-word inline-block">Cats</span>
            </h2>
          </div>
          <p className="text-[#6E6F73] text-base leading-relaxed max-w-md">
            Track lions on the plains and leopards through acacia woodlands—guided by local experts.
          </p>
        </div>
      </div>
      ...
      >
        <div className="px-6 md:px-[6vw] w-full max-w-full md:max-w-[38vw]">
          <p className="text-[#6E6F73] text-base leading-relaxed mb-6 max-w-md">
            We time your drives for golden light, quieter reserves, and the best viewing zones.
          </p>
          <button
